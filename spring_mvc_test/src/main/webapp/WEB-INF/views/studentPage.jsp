...
<nav class="navbar navbar-light bg-light">
    <a class="navbar-brand" href="index">
        <img src="${ pageContext.request.contextPath }/resources/image/logo.png"  alt="logo_Youcode">
    </a>
        ...
        <div>
            <form action="addNewReservation" method="POST" >
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="Image"><span class="fieldInfo">Select Date </span></label>
                        <input  type="date" class ="form-control" name="date" id="Image"placeholder="Select date">

                    </div>
                    <br>
                    <br>
                    <input class="btn btn-success" type="submit" name="submit" value="Reserve">
                </fieldset>
...
<footer class="row footer">
    <div class="col-md-12">
        <p class="text-dark">All <span>@CopyRight@ 2021</span>  Reserved For Youcode</p>
    </div>
</footer>
</div>
</body>
