...
//DAO_USER
       ...
       //Users user1 = user.getUserById(2L);
 ...
 ///DAO_STUDENT
       // StudentDao student=new StudentDaoImpl();
        //student.createStudent(new Student("karim","kamil","gmail@l.ma","root",null,null,role,user1,true));
...
//Dao admin
    //	AdminDao user = new AdminDaoImpl();
        ...
        //System.out.println("ww  :"+list);
       //user.createAdministrator(new Administrator("kaddour","meach","kaddour@gmail.com","admin",null ,null,null));
    	...
    	rr.getReservationStudent(4L);
    	System.out.println(rr.getReservationStudent(4L));
